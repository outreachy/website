...
urlpatterns = [
    ...
    url(r'^communities/cfp/(?P<community_slug>[^/]+)/coordinator-update/(?P<coordinator_id>/d+)/$', community_coordinator_update, name='community-coordinator-update'),
    url(r'^communities/cfp/(?P<community_slug>[^/]+)/(?P<project_slug>[^/]+)/mentor-status/(?P<mentor_id>/d+)/$', project_mentor_update, name='project-mentor-status'),

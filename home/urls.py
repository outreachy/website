...
urlpatterns = [
    ...
    url(r'^communities/cfp/(?P<community_slug>[^/]+)/edit/$', views.CommunityUpdate.as_view(), name='community-update'),
    ...
    url(r'^communities/cfp/(?P<community_slug>[^/]+)/$', views.community_read_only_view, name='community-read-only'),

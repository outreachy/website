...
urlpatterns = [
    ...
    url(r'^email/internship-week-three/$', views.InternWeekThree.as_view(), name='email-internship-week-three'),
    url(r'^email/internship-week-five/$', views.InternWeekFive.as_view(), name='email-internship-week-five'),

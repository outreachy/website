...
round_patterns = [
    ...
    url(r'^initial-feedback-queue/$', views.initial_feedback_queue, name='initial-feedback-queue'),
    url(r'^queue-initial-feedback/(?P<username>[^/]+)/', views.queue_initial_feedback_payment_authorization, name='queue-initial-feedback'),
    url(r'^export-initial-feedback-queue/$', views.export_initial_feedback_queue, name='export-initial-feedback-queue'),
    url(r'^dequeue-initial-feedback/(?P<username>[^/]+)/', views.dequeue_initial_feedback_payment_authorization, name='dequeue-initial-feedback'),
    url(r'^process-initial-feedback-queue/$', views.process_queued_initial_feedback_payment_authorizations, name='process-initial-feedback-queue'),

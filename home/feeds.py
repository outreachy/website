...
class WagtailFeed(Feed):
    ...
    def items(self, obj):
        ...
        items.append(PseudoPage(
            title='Call for May 2025 mentoring communities',
            full_url=reverse('2025-01-cfp-open'),
            owner=author,
            first_published_at=pacific.localize(datetime.datetime(2025, 1, 15, 16, 00, 0)),
            last_published_at=pacific.localize(datetime.datetime(2025, 1, 15, 16, 00, 0)),
        ))
